...
<form name="cart" method="post">	
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">TRACK ID</th>
...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as proid,orders.productId as opid, orders.orderStatus as ordStatus, orders.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
$cnt=1;
...
?>
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php?pid=<?php echo htmlentities($row['proid']);?>">
					...
					<td class="cart-product-sub-total"><?php echo $row['ordStatus']; ?>  </td>
